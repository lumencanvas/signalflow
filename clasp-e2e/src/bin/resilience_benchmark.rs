...
async fn main() {
    ...
    println!(
        "  ✓ Reconnection (n=50) | p50: {}µs | p99: {}µs | avg: {}µs\n",
        p50, p99, avg
    );
    ...
    for params in [100, 500, 1000, 5000] {
        ...
        println!(
            "  {} {:>5} params recovered in {:>8.2?} ({:.0} params/s)",
    ...
    for (msgs, duration) in [(1000, 1000), (5000, 2000), (10000, 5000)] {
        ...
        println!(
            "  {} {:>5} msgs over {}ms | sent: {} | recv: {} | loss: {:.1}% | {:.0} msg/s",
